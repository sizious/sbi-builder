...
procedure TSplashScreen_Form.BmpToForm(BMP : TImage; CouleurTransparente : TColor);
var
    i, j, debutY : Integer;
    rgn, rgn1 : HRGN;
...
procedure TSplashScreen_Form.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  ScrBmp.Free;
  MixBmp.Free;
end;
...
procedure TSplashScreen_Form.WMEraseBkgnd(var msg: TWMErasebkgnd);
begin
...
procedure TSplashScreen_Form.DoFade(Duree: integer);
var
...
procedure TSplashScreen_Form.Afterfade;
begin
...
procedure TSplashScreen_Form.Wait(Duree: integer);
var
   i: integer;
begin
